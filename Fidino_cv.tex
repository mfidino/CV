...
\cvitem{2019}{A city's size and proportion of green space affects mammalian relative occupancy and response to urbanization: an analysis of 10 cities across the United States. The International Urban Wildlife Conference. Portland, Oregon.}
...
\cvitem{2025}{\textbf{Lecture:} Building networks for urban wildlife research: biodiversity and disease across cities. University of Pennsylvania. Philadelphia, Pennsylvania}
\cvitem{---}{\textbf{Sherwood Ebey Lecture Series:} Scaling up urban biodiversity monitoring with coordinated research networks. Sewanee. Sewanee, Tennessee}
...
\cvitem{}{\textit{Current total}: 7.12 million dollars, US.}
\cvitem{2025}{\textbf{Grainger Foundation} -- Urban Wildlife Information Network expansion (Co-PI, \$1,000,000).}
...
\cvitem{2025}{\textbf{Introduction to research:} Taught a course to new University of Chicago graduate students in the Committee for Evolutionary Biology about my research, Chicago, Illinois.}
\cvitem{---}{\textbf{Workshop on GitHub and data reproducibility} Developed and ran a four hour workshop to teach the basics of using GitHub for scientific research to University of Chicago graduate Students, Chicago, Illinois.}
\cvitem{---}{\textbf{Workshop on camera trapping, reproducible science, and statistical modeling:} Developed and ran two day workshop on camera trap study design, reproducible science, and occupancy modeling to Urban Wildlife Information Network partners in San Carlos de Bariloche, Argentina.}
